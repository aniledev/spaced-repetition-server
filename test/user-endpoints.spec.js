    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "el programacíon", translation: "programming" },
            { original: "la computadora", translation: "computer" },
            { original: "la programadora", translation: "programmer" },
            { original: "el algoritmo", translation: "algorithm" },
            { original: "el aplicacíon", translation: "application" },
            { original: "el compilador", translation: "compiler" },
            { original: "el objeto", translation: "object" },
            { original: "la interfaz", translation: "interface" },
            { original: "el servidor", translation: "server" },
            { original: "el cliente", translation: "client" },
          ],
        };
        return supertest(app)
          .post("/api/user")
